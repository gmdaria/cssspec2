...
public class Lexical {
    public static void main(String[] args) {
        ...
        String datatypepattern = "double|float|int";
        Pattern datatype= Pattern.compile(datatypepattern);
        Matcher datatypematcher = datatype.matcher(line);
        while(datatypematcher.find()){
            System.out.println("TOKEN: " + datatypematcher.group(0));
            System.out.println("SYMBOLIC NAME:DATATYPE");
        }
